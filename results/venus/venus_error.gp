...
# Begin plot
mode = ARG1
fileout = 'venus_err'.mode.'.pdf'
file1 = ARG2.'/venus_err_'.ARG1.'.txt'
...
#set yrange [-1.2:1.2]
plot file1 u 1:($2 - $19) title '' with lines lt 3 lw 2 lc 6

# R12
@next_subplot
set xlabel ''; set format x ''
plot file1 u 1:($3 - $20) title '' with lines lt 3 lw 2 lc 6

# R13
@next_subplot
set xlabel ''; set format x ''
plot file1 u 1:($4 - $21) title '' with lines lt 3 lw 2 lc 6

# R14
@next_subplot
set xlabel ''; set format x ''
plot file1 u 1:($5 - $22)  title '' with lines lt 3 lw 2 lc 6
...
set title ''
set xlabel ''; set format x ''
plot file1 u 1:($6 - $23) title '' with lines lt 3 lw 2 lc 6

@next_subplot
set title ''
set xlabel ''; set format x ''
plot file1 u 1:($7 - $24) title '' with lines lt 3 lw 2 lc 6

@next_subplot
set title ''
set xlabel ''; set format x ''
plot file1 u 1:($8 - $25) title '' with lines lt 3 lw 2 lc 6

@next_subplot
set title ''
set xlabel ''; set format x ''
plot file1 u 1:($9 - $26) title '' with lines lt 3 lw 2 lc 6

# ROW 3
@next_subplot
set title ''
set xlabel ''; set format x ''
plot file1 u 1:($10 - $27) title '' with lines lt 3 lw 2 lc 6

@next_subplot
set title ''
set xlabel ''; set format x ''
plot file1 u 1:($11 - $28) title '' with lines lt 3 lw 2 lc 6

@next_subplot
set title ''
set xlabel ''; set format x ''
plot file1 u 1:($12 - $29) title '' with lines lt 3 lw 2 lc 6

@next_subplot
set title ''
set xlabel ''; set format x ''
plot file1 u 1:($13 - $30) title '' with lines lt 3 lw 2 lc 6

# ROW 4
@next_subplot
set title ''
set xlabel '$\mu$'; set format x '%g'
plot file1 u 1:($14 - $31) title '' with lines lt 3 lw 2 lc 6

@next_subplot
set title ''
set xlabel '$\mu$'; set format x '%g'
plot file1 u 1:($15 - $32) title '' with lines lt 3 lw 2 lc 6

@next_subplot
set title ''
set xlabel '$\mu$'; set format x '%g'
plot file1 u 1:($16 - $33) title '' with lines lt 3 lw 2 lc 6

@next_subplot
set title ''
set xlabel '$\mu$'; set format x '%g'
plot file1 u 1:($17 - $34) title '' with lines lt 3 lw 2 lc 6
